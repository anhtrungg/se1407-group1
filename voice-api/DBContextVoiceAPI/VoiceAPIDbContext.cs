...
namespace VoiceAPI.DbContextVoiceAPI
{
    public class VoiceAPIDbContext : DbContext
    {
        ...
        static VoiceAPIDbContext()
        {
            ...
            NpgsqlConnection.GlobalTypeMapper.MapEnum<LanguageEnum>(pgName: "Language");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Job>().Property(j => j.Gender).HasDefaultValue(GenderEnum.OTHER);
            modelBuilder.Entity<Job>().Property(j => j.Language).HasDefaultValue(LanguageEnum.VIETNAM);
            ...
            modelBuilder.HasPostgresEnum<LanguageEnum>(name: "Language");
        }
    }
}
